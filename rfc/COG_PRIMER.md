diff --git a/c:\Projects\CausalGraphTheory\rfc\COG_PRIMER_DRAFT.md b/c:\Projects\CausalGraphTheory\rfc\COG_PRIMER_DRAFT.md
deleted file mode 100644
--- a/c:\Projects\CausalGraphTheory\rfc\COG_PRIMER_DRAFT.md
+++ /dev/null
@@ -1,724 +0,0 @@
-# The Causal Octonion Graph — A Physical Primer
-*Draft for Research Director onboarding. To be condensed before injection.*
-*Written 2026-02-27. Covers all locked architecture decisions through RFC-028.*
-
----
-
...
-
-```
-ψ = (ψ₀, ψ₁, ψ₂, ψ₃, ψ₄, ψ₅, ψ₆, ψ₇)    where each ψᵢ ∈ ℤ
-```
-
-The eight components correspond to the eight basis directions of the octonion algebra:
-the real direction e₀ = 1, and seven imaginary directions e₁ through e₇. The tensor
-product with the complex numbers means each component can carry an additional factor
-of the complex unit *i* (which commutes with everything), so the full state is
-actually 16 integers if we split real and imaginary parts — but we work with the
-compact 8-integer representation and treat *i* as a decoration.
-
...
-of which are ±1 times a basis element, and all of them follow from six numbers:
-the seven directed triples above.
-
...
-  psi:        ℂ⊗𝕆 over ℤ         — the full 8-integer complex octonion state
...
-| ψ | Node state vector — 8 integers |
...
----
-
-*End of draft primer. This document is approximately 5,800 words.
-Recommended condensation target: 1,500–2,000 words for Research Director injection.*
