"""Compatibility wrapper for parallel fine-structure case generation.

Use this script when you specifically want multiprocessing defaults.
It forwards to `generate_fine_structure_20_cases.py` implementation.
"""
...
from generate_fine_structure_20_cases import RESULTS_ROOT, execute_cases_incremental


def main() -> None:
    parser = argparse.ArgumentParser(description="Parallel runner for 20 fine-structure COG cases.")
    parser.add_argument(
        "--output-dir",
    ...
    if not args.execute:
        raise SystemExit(
            ...
            "python world_code/Python_code/generate_fine_structure_20_cases_parallel.py "
