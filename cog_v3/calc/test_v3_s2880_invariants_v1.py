"""Smoke test for build_v3_s2880_invariants_v1."""
...
from cog_v3.calc import build_v3_s2880_invariants_v1 as mod
...
def main() -> None:
    ...
    if payload["schema_version"] != "v3_s2880_invariants_v1":
        raise AssertionError("schema mismatch")
    if int(payload["summary"]["s2880_size"]) != 2880:
    ...
    print("ok: test_v3_s2880_invariants_v1")
