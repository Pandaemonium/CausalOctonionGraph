...
OUT_MD = Path("cog_v4/sources/v4_small_system_coherent_sim_v1.md")
OUT_JSON = Path("cog_v4/sources/v4_small_system_coherent_sim_v1.json")
...
def _render_md(payload: Dict[str, Any]) -> str:
    ...
    lines = [
        "# v4 Small-System Coherent Lightcone Sim (v1)",
        "",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Build v4 small-system coherent lightcone simulation artifact.")
